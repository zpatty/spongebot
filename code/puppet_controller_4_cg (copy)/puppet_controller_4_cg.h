...
extern void puppet_controller_4_cg(
    ...
    double L0, const double Kp[256], const double KD[256], double kc, double ka,
    double offset, double contact, double conv_pcc, double conv_motor,
    double tau[16], double cvec[4]);
