...
static real_T (*g_emlrt_marshallIn(const emlrtStack *sp, const mxArray *xd,
                                   ...
                                   const char_T *identifier))[3]
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = h_emlrt_marshallIn(sp, emlrtAlias(xd), &thisId);
                                ...
                                const mxArray *plhs[4])
{
  ...
  tau_r = (real_T(*)[16])mxMalloc(sizeof(real_T[16]));
  x = (real_T(*)[3])mxMalloc(sizeof(real_T[3]));
  cq = (real_T(*)[4])mxMalloc(sizeof(real_T[4]));
  ...
  bm = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[15]), "bm");
  L0 = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[16]), "L0");
  Kp = e_emlrt_marshallIn(&st, emlrtAlias(prhs[17]), "Kp");
  KD = e_emlrt_marshallIn(&st, emlrtAlias(prhs[18]), "KD");
  Kpx = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[19]), "Kpx");
  KDx = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[20]), "KDx");
  xd = g_emlrt_marshallIn(&st, emlrtAlias(prhs[21]), "xd");
  dxd = g_emlrt_marshallIn(&st, emlrtAlias(prhs[22]), "dxd");
  dxr = g_emlrt_marshallIn(&st, emlrtAlias(prhs[23]), "dxr");
  kc = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[24]), "kc");
  ka = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[25]), "ka");
  offset = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[26]), "offset");
  contact = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[27]), "contact");
  conv_pcc = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[28]), "conv_pcc");
  conv_motor = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[29]), "conv_motor");
  /* Invoke the target function */
  puppet_controller_4_cg(*q, *dq, *qd, *dqd, *ddqd, d, m, mm, hm, rm, r, kb, ks,
                         bb, bs, bm, L0, *Kp, *KD, Kpx, KDx, *xd, *dxd, *dxr,
                         kc, ka, offset, contact, conv_pcc, conv_motor, *tau,
                         *tau_r, *x, *cq);
