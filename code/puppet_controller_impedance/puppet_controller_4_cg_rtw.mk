...
## Generated on : Wed Dec 06 17:13:28 2023
...
SRCS = $(MATLAB_ROOT)/git-repos/matlab/DRL/pushpuppets/codegen/dll/puppet_controller_4_cg/rt_nonfinite.c $(MATLAB_ROOT)/git-repos/matlab/DRL/pushpuppets/codegen/dll/puppet_controller_4_cg/rtGetNaN.c $(MATLAB_ROOT)/git-repos/matlab/DRL/pushpuppets/codegen/dll/puppet_controller_4_cg/rtGetInf.c $(MATLAB_ROOT)/git-repos/matlab/DRL/pushpuppets/codegen/dll/puppet_controller_4_cg/puppet_controller_4_cg_initialize.c $(MATLAB_ROOT)/git-repos/matlab/DRL/pushpuppets/codegen/dll/puppet_controller_4_cg/puppet_controller_4_cg_terminate.c $(MATLAB_ROOT)/git-repos/matlab/DRL/pushpuppets/codegen/dll/puppet_controller_4_cg/puppet_controller_4_cg.c $(MATLAB_ROOT)/git-repos/matlab/DRL/pushpuppets/codegen/dll/puppet_controller_4_cg/MC_4_cg.c $(MATLAB_ROOT)/git-repos/matlab/DRL/pushpuppets/codegen/dll/puppet_controller_4_cg/PCC_jacobian.c $(MATLAB_ROOT)/git-repos/matlab/DRL/pushpuppets/codegen/dll/puppet_controller_4_cg/J_r.c $(MATLAB_ROOT)/git-repos/matlab/DRL/pushpuppets/codegen/dll/puppet_controller_4_cg/mldivide.c $(MATLAB_ROOT)/git-repos/matlab/DRL/pushpuppets/codegen/dll/puppet_controller_4_cg/xgetrf.c $(MATLAB_ROOT)/git-repos/matlab/DRL/pushpuppets/codegen/dll/puppet_controller_4_cg/puppet_controller_4_cg_rtwutil.c
...
OBJS = rt_nonfinite.o rtGetNaN.o rtGetInf.o puppet_controller_4_cg_initialize.o puppet_controller_4_cg_terminate.o puppet_controller_4_cg.o MC_4_cg.o PCC_jacobian.o J_r.o mldivide.o xgetrf.o puppet_controller_4_cg_rtwutil.o
...
J_r.o : $(MATLAB_ROOT)/git-repos/matlab/DRL/pushpuppets/codegen/dll/puppet_controller_4_cg/J_r.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mldivide.o : $(MATLAB_ROOT)/git-repos/matlab/DRL/pushpuppets/codegen/dll/puppet_controller_4_cg/mldivide.c
	$(CC) $(CFLAGS) -o "$@" "$<"


xgetrf.o : $(MATLAB_ROOT)/git-repos/matlab/DRL/pushpuppets/codegen/dll/puppet_controller_4_cg/xgetrf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
