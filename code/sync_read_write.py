...
Mod1 = Mod(packetHandler, portHandler, [1,2,3])
# Mod2 = Mod(packetHandler, portHandler, [4,5,6])
# Mod3 = Mod(packetHandler, portHandler, [7,8,9])
# Mod1.enable_torque()
# print(Mod1.get_position())
# print(Mod2.get_position())
# print(Mod3.get_position())
# Mod1.enable_torque()
# Mod1.send_torque_cmd([50,50,50])
# time.sleep(2)
# Mod1.disable_torque()
while 1:
